...
# FROM NOW, WE CAN CALL THIS DATASET 'TRAINING_DATA' SINCE WE ARE GOING TO BUILD OUR MODELS BASED ON THESE

# GENERATE A 'TEST_DATA' WITH NEW X'S, AND CORRESPONDING FX'S AND Y'S
# JUST ONE SET OF DATA WITH SAY 100 OBSERVATIONS (SAME CODE AS IN LINES 8-16, EXCEPT YOU WOULD REPLICATE ONLY ONCE, PROBABLY NEED TO USE A DIFFERENT SEED FOR THAT)
# SEE COMMENTS ON LINES 44, 48, 50, 54-55, 71
...
errors <- replicate(300, rnorm(n = 500, mean = 0, sd = 2))  # error terms
a <- 3
b <- 0.87
fx <- a + (b * x)  # true function
